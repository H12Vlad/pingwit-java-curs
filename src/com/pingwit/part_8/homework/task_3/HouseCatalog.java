...
public class HouseCatalog {
        ...
        // Другие методы для работы с каталогом, например, поиск по параметрам и т.д. -> к таким комментариям попробуй добавить todo в начало, тогда их легко найти + в левом нижнем углу в идее есть вкладка 'TODO'
    }
